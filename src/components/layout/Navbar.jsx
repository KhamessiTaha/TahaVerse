  ...
  return (
    <>
      ...
      >
        ...
        {/* Menu Content */}
        <div
          className={`absolute right-0 top-0 h-full w-80 bg-gradient-to-br from-gray-900/95 to-black/95 backdrop-blur-xl border-l border-cyan-400/20 transform transition-transform duration-500 ${
